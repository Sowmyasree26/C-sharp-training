...
namespace Question1.Models
{
    ...
    public partial class northwindEntities : DbContext
    {
        ...
        [DbFunction("northwindEntities", "fn_CustomerWithCountryName")]
        public virtual IQueryable<fn_CustomerWithCountryName_Result> fn_CustomerWithCountryName(string countryname)
        {
            var countrynameParameter = countryname != null ?
                new ObjectParameter("countryname", countryname) :
                new ObjectParameter("countryname", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_CustomerWithCountryName_Result>("[northwindEntities].[fn_CustomerWithCountryName](@countryname)", countrynameParameter);
        }
